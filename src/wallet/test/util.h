...
#ifndef QTY_WALLET_TEST_UTIL_H
#define QTY_WALLET_TEST_UTIL_H
...
// Witness v0, 32-byte all-zero program, under regtest's "qcqty" prefix. The
// upstream constant kept Bitcoin's "bcrt" prefix, which no QTY chain decodes.
const std::string ADDRESS_QCRT1_UNSPENDABLE = "qcqty1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqen882c";
