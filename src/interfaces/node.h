...
#ifndef QTY_INTERFACES_NODE_H
#define QTY_INTERFACES_NODE_H
...
//! Top-level interface for a qty node (qtyd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or qty.conf.
