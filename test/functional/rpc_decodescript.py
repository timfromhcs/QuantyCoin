...
class DecodeScriptTest(QTYTestFramework):
    ...
    def decodescript_miniscript(self):
        ...
        # Sourced from https://github.com/qty/qty/pull/27037#issuecomment-1416151907.
        ...
        assert res["segwit"]["desc"] == "addr(qcqty1q73qyfypp47hvgnkjqnav0j3k2lq3v76wg22dk8tmwuz5sfgv66xsynnyjk)#k68c7f73"
