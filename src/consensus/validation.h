...
#ifndef QTY_CONSENSUS_VALIDATION_H
#define QTY_CONSENSUS_VALIDATION_H
...
// QTY: Witness discount restored with WITNESS_SCALE_FACTOR = 16.
...
#endif // QTY_CONSENSUS_VALIDATION_H
