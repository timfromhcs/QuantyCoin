...
This document provides guidelines for internationalization of the QTY Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `qty_en.ts` remains unchanged.
