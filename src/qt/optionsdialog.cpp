      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->qtyAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->qtyAtStartup);
    ...
    ui->qtyAtStartup->setToolTip(ui->qtyAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->qtyAtStartup->setText(ui->qtyAtStartup->text().arg(PACKAGE_NAME));

    ui->openQTYConfButton->setToolTip(ui->openQTYConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new QTYUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->qtyAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openQTYConfButton_clicked()
{
