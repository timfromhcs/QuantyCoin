...
QTY Core version 0.19.1 is now available from:

  <https://qtycore.org/bin/qty-core-0.19.1/>
...
From QTY Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as QTY Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, QTY Core does not yet change appearance when
...
- #17488 fix "qtyd already running" warnings on macOS (fanquake)
