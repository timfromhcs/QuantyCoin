...
#ifndef QTY_WALLET_TRANSACTION_H
#define QTY_WALLET_TRANSACTION_H
...
public:
     ...
     * on this qty node, and set to 0 for transactions that were created
...
#endif // QTY_WALLET_TRANSACTION_H
