...
#ifndef QTY_TEST_UTIL_SETUP_COMMON_H
#define QTY_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
    ...
    explicit BasicTestingSetup(const ChainType chainType = ChainType::QTYMAIN, const std::vector<const char*>& extra_args = {});
    ~BasicTestingSetup();
...
struct ChainTestingSetup : public BasicTestingSetup {
    ...
    explicit ChainTestingSetup(const ChainType chainType = ChainType::QTYMAIN, const std::vector<const char*>& extra_args = {});
    ~ChainTestingSetup();
...
struct TestingSetup : public ChainTestingSetup {
    explicit TestingSetup(
        const ChainType chainType = ChainType::QTYMAIN,
...
struct RegTestingSetup : public TestingSetup {
    RegTestingSetup()
        : TestingSetup{ChainType::QTYREGTEST} {}
};
...
struct TestChain100Setup : public TestingSetup {
    TestChain100Setup(
        const ChainType chain_type = ChainType::QTYREGTEST,
        const std::vector<const char*>& extra_args = {},
        const bool coins_db_in_memory = true,
        const bool block_tree_db_in_memory = true);
...
std::unique_ptr<T> MakeNoLogFileContext(const ChainType chain_type = ChainType::QTYREGTEST, const std::vector<const char*>& extra_args = {})
{
...
#endif // QTY_TEST_UTIL_SETUP_COMMON_H
