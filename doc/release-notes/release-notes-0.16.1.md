QTY Core version 0.16.1 is now available from:

  <https://qtycore.org/bin/qty-core-0.16.1/>
...
- #12843 `df38b13` Test starting qtyd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure qtyd processes are cleaned up when tests end (sdaftuar)
