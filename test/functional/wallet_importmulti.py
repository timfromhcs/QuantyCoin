...
class ImportMultiTest(QTYTestFramework):
    ...
    def run_test(self):
        ...
        # QTY Address (implicit non-internal)
        ...
        self.test_importmulti(
            {
                "scriptPubKey": {"address": "qcqty1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqsjn9ns"},
                "timestamp": "now",
            },
            success=False,
            error_code=-5,
