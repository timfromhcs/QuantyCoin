...
class TxnMallTest(QTYTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 QTY:
        ...
        # First: use raw transaction API to send 1240 QTY to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 QTY coin each
