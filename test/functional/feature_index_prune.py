...
class FeatureIndexPruneTest(QTYTestFramework):
    ...
    def run_test(self):
        ...
        # QTY: Avoid relying on Bitcoin-specific block file boundaries. Ensure both nodes pruned to the same
        ...
        # QTY: Block file boundaries differ; assert all nodes pruned to same height and within range
