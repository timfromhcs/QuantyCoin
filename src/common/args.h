...
#ifndef QTY_COMMON_ARGS_H
#define QTY_COMMON_ARGS_H
...
extern const char * const QTY_CONF_FILENAME;
extern const char * const QTY_SETTINGS_FILENAME;
...
protected:
    ...
    ChainType m_fallback_chain_type GUARDED_BY(cs_args){ChainType::QTYMAIN};
 ...
 public:
     ...
     * settings, the configured fallback applies (normally mainnet; qty-qt sets test).
