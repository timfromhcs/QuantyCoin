...
#ifndef QTY_QT_QTYUNITS_H
#define QTY_QT_QTYUNITS_H
...
/** QTY unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class QTYUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit QTYUnits(QObject *parent);

    /** QTY units.
      @note Source: https://en.qty.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        QTY,
        mBTC,
