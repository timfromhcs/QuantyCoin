# Bootstrappable QTY Core Builds

This directory contains the files necessary to perform bootstrappable QTY
Core builds.
...
To build QTY Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/qty-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/qty-core/guix.sigs).
