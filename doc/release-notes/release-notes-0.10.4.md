QTY Core version 0.10.4 is now available from:

  <https://qty.org/bin/qty-core-0.10.4/>
...
- #6953 `43c2789` Split qty-tx into its own package
- #6953 `dfe0d4d` Include qty-tx binary on Debian/Ubuntu
