...
#ifndef QTY_CONSENSUS_PARAMS_H
#define QTY_CONSENSUS_PARAMS_H
...
struct Params {
     ...
     * QTY uses 20160 blocks (14 days / 1-minute blocks). Examples: 18144 for 90%, 15120 for testchains.
     */
    ...
    /** Height at which Dilithium opcodes become P2MR-only (QTY-AUDIT-048).
     ...
     *  covers 7.5 hours. At QTY's 60-second spacing it covered 45 minutes --
    ...
    /**
     * If true, witness commitments contain a payload equal to a QTY Script solution
