...
export PACKAGES="gcc-9 g++-9 python3-zmq qtyase5-dev qttools5-dev-tools libdbus-1-dev libharfbuzz-dev"
...
export QTY_CONFIG="--enable-zmq --with-libs=no --with-gui=qt5 --enable-reduce-exports --enable-debug \
