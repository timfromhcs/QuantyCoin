...
complete --command qtyd --no-files

# Extract options
function __fish_qtyd_get_options
...
complete \
    --command qtyd \
    --arguments "(__fish_qtyd_get_options --nofiles)"
