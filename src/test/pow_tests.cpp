...
{
    const auto consensus = CreateChainParams(*m_node.args, ChainType::QTYMAIN)->GetConsensus();
    uint256 hash;
    unsigned int nBits;
...
{
    sanity_check_chainparams(*m_node.args, ChainType::QTYMAIN);
}

BOOST_AUTO_TEST_CASE(ChainParams_REGTEST_sanity)
{
    sanity_check_chainparams(*m_node.args, ChainType::QTYREGTEST);
}

BOOST_AUTO_TEST_CASE(ChainParams_TESTNET_sanity)
{
    sanity_check_chainparams(*m_node.args, ChainType::QTYTEST);
}

BOOST_AUTO_TEST_CASE(ChainParams_SIGNET_sanity)
{
    sanity_check_chainparams(*m_node.args, ChainType::QTYSIGNET);
}
