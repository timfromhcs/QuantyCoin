...
export CONTAINER_NAME=ci_native_nowallet_libqtykernel
...
export GOAL="install"
export QTY_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
