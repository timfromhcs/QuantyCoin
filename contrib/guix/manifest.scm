...
(define* (make-qty-cross-toolchain target
                                       #:key
...
desirable for building QTY Core release binaries."
...
;; failure; see https://github.com/qty/qty/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-qty-cross-toolchain target)))
