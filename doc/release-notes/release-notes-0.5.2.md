QTY version 0.5.2 is now available for download at:
http://sourceforge.net/projects/qty/files/QTY/qty-0.5.2/
...
http://gitorious.org/qty/qtyd-stable/archive-tarball/v0.5.2#.tar.gz
