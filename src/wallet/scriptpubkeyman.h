...
#ifndef QTY_WALLET_SCRIPTPUBKEYMAN_H
#define QTY_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The QTY Core wallet was originally a collection of unrelated private
...
#endif // QTY_WALLET_SCRIPTPUBKEYMAN_H
