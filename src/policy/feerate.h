...
#ifndef QTY_POLICY_FEERATE_H
#define QTY_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "QTY"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BTC_KVB,      //!< Use QTY/kvB fee rate unit
