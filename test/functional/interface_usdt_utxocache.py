...
""" Tests the utxocache:* tracepoint API interface.
    See https://github.com/qty/qty/blob/master/doc/tracing.md#context-utxocache
"""
...
class UTXOCacheTracepointTest(QTYTestFramework):
    ...
    def skip_test_if_missing_module(self):
        ...
        self.skip_if_no_qtyd_tracepoints()
    ...
    def test_uncache(self):
        ...
        https://github.com/qty/qty/blob/master/doc/tracing.md#tracepoint-utxocacheuncache
        """
        ...
        def handle_utxocache_uncache(_, data, __):
            ...
            try:
                ...
                assert_equal(5 * COIN, event.value)
    ...
    def test_add_spent(self):
        """ Tests the utxocache:add utxocache:spent tracepoint API
            See https://github.com/qty/qty/blob/master/doc/tracing.md#tracepoint-utxocacheadd
            and https://github.com/qty/qty/blob/master/doc/tracing.md#tracepoint-utxocachespent
        """
    ...
    def test_flush(self):
        """ Tests the utxocache:flush tracepoint API.
            See https://github.com/qty/qty/blob/master/doc/tracing.md#tracepoint-utxocacheflush"""
