...
By default, qtyd will dump mempool on shutdown and
...
class MempoolPersistTest(QTYTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent qtyd from writing mempool.dat to disk. Verify that `savemempool` fails")
