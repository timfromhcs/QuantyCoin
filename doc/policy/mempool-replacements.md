...
1. The directly conflicting transactions all signal replaceability explicitly. A transaction is
   ...
   *Rationale*: See [BIP125
   explanation](https://github.com/qty/bips/blob/master/bip-0125.mediawiki#motivation).
...
* Opt-in full replace-by-fee (without inherited signaling) honoured in mempool and mining as of
  **v0.12.0** ([PR 6871](https://github.com/qty/qty/pull/6871)).

* [BIP125](https://github.com/qty/bips/blob/master/bip-0125.mediawiki) defined based on
  QTY Core implementation.
