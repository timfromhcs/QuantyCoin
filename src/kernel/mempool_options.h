...
#ifndef QTY_KERNEL_MEMPOOL_OPTIONS_H
#define QTY_KERNEL_MEMPOOL_OPTIONS_H
 ...
 *  AppInitMain requires maxmempool >= descendant_size_vbytes * 40. QTY raised
...
#endif // QTY_KERNEL_MEMPOOL_OPTIONS_H
