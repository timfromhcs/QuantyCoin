#!/usr/bin/env python3
# Copyright (c) 2015-2021 The QTY Core developers
...
class InvalidBlockRequestTest(QTYTestFramework):
    ...
    def run_test(self):
        ...
        tx1 = create_tx_with_script(block1.vtx[0], 0, script_sig=bytes([OP_TRUE]), amount=5 * COIN)
        tx2 = create_tx_with_script(tx1, 0, script_sig=bytes([OP_TRUE]), amount=5 * COIN)
        ...
        tx3 = create_tx_with_script(tx2, 0, script_sig=bytes([OP_TRUE]), amount=5 * COIN)
