// Copyright (c) 2019-2020 The QTY Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef QTY_TEST_UTIL_TRANSACTION_UTILS_H
#define QTY_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // QTY_TEST_UTIL_TRANSACTION_UTILS_H
