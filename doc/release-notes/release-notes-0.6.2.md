QTY version 0.6.2 is now available for download at:
http://sourceforge.net/projects/qty/files/QTY/qty-0.6.2/
...
Fixed https://github.com/qty/qty/issues/1065, a bug that
