...
BOOST_AUTO_TEST_CASE(versionbits_computeblockversion)
{
    ...
    for (const auto& chain_type: {ChainType::QTYMAIN, ChainType::QTYTEST, ChainType::QTYSIGNET, ChainType::QTYREGTEST}) {
...

    {
        ...
        const auto chainParams = CreateChainParams(args, ChainType::QTYREGTEST);
