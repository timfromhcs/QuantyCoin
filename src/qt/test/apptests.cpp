...
//! Entry point for QTYApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &QTYApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for QTYGUI tests.
void AppTests::guiTests(QTYGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &QTYGUI::consoleShown, this, &AppTests::consoleTests);
