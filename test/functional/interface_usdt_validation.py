...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/qty/qty/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(QTYTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/qty/qty/blob/master/doc/tracing.md#tracepoint-validationblock_connected
