...
{
    BOOST_CHECK(TestSplitHost("www.qtycore.org", "www.qtycore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.qtycore.org]", "www.qtycore.org", 0));
    BOOST_CHECK(TestSplitHost("www.qtycore.org:80", "www.qtycore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.qtycore.org]:80", "www.qtycore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.qtycore.org:65536", "www.qtycore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.qtycore.org:0", "www.qtycore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.qtycore.org:", "www.qtycore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(node_qty_dilithium_service_bit)
{
    ...
    BOOST_CHECK_EQUAL(static_cast<uint64_t>(NODE_QTY_DILITHIUM), 1ULL << 25);

    const auto names = serviceFlagsToStr(NODE_QTY_DILITHIUM);
    BOOST_REQUIRE_EQUAL(names.size(), 1U);
    BOOST_CHECK_EQUAL(names.at(0), "QTY_DILITHIUM");
    ...
    BOOST_CHECK(!(GetDesirableServiceFlags(NODE_NONE) & NODE_QTY_DILITHIUM));
    BOOST_CHECK(HasAllDesirableServiceFlags(ServiceFlags(NODE_NETWORK | NODE_WITNESS)));
    BOOST_CHECK(HasAllDesirableServiceFlags(ServiceFlags(NODE_NETWORK | NODE_WITNESS | NODE_QTY_DILITHIUM)));
    ...
    BOOST_CHECK(!(GetDesirableServiceFlags(NODE_NETWORK_LIMITED) & NODE_QTY_DILITHIUM));
