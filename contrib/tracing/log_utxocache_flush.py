...
"""Example logging QTY Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/qtyd
...
def main(qtyd_path):
    ...
    b = BPF(text=program, usdt_contexts=[qtyd_with_usdts])
