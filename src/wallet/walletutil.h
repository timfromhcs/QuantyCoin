...
#ifndef QTY_WALLET_WALLETUTIL_H
#define QTY_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! qty from opening the wallet, thinking it was newly created, and
