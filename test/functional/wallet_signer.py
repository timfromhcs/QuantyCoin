...
Verify that a qtyd node can use an external signer command
...
class WalletSignerTest(QTYTestFramework):
    ...
    def test_valid_signer(self):
        ...
        assert_equal(address1, "qcqty1qm90ugl4d48jv8n6e5t9ln6t9zlpm5th6ff7pn9")
        ...
        assert_equal(address4, "qcqty1phw4cgpt6cd30kz9k4wkpwm872cdvhss29jga2xpmftelhqll62msav7wwc")
