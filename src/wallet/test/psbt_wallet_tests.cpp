    ...
    EXCLUSIVE_LOCKS_REQUIRED(wallet.cs_wallet)
{
    ...
    // Not assert(): a descriptor that stops parsing (stale key material, say)
    // would otherwise abort the whole test binary rather than fail this case.
    BOOST_REQUIRE_MESSAGE(desc, "failed to parse descriptor: " << error);
...
BOOST_AUTO_TEST_CASE(psbt_updater_test)
{
    ...
    import_descriptor(m_wallet, "sh(multi(2,xprvJAihJkudK4AghKBSHgfF5zsqg9QfxpueL2QKVhRTQ16eGYMiBGNEn7ZE9zsjGp1xTSaDuKSRKPVsXoB5viuPNdfpGKFUy33w5XV5nFqpqoN/0h/0h/0h,xprvJAihJkudK4AghKBSHgfF5zsqg9QfxpueL2QKVhRTQ16eGYMiBGNEn7ZE9zsjGp1xTSaDuKSRKPVsXoB5viuPNdfpGKFUy33w5XV5nFqpqoN/0h/0h/1h))");
    import_descriptor(m_wallet, "sh(wsh(multi(2,xprvJAihJkudK4AghKBSHgfF5zsqg9QfxpueL2QKVhRTQ16eGYMiBGNEn7ZE9zsjGp1xTSaDuKSRKPVsXoB5viuPNdfpGKFUy33w5XV5nFqpqoN/0h/0h/2h,xprvJAihJkudK4AghKBSHgfF5zsqg9QfxpueL2QKVhRTQ16eGYMiBGNEn7ZE9zsjGp1xTSaDuKSRKPVsXoB5viuPNdfpGKFUy33w5XV5nFqpqoN/0h/0h/3h)))");
    import_descriptor(m_wallet, "wpkh(xprvJAihJkudK4AghKBSHgfF5zsqg9QfxpueL2QKVhRTQ16eGYMiBGNEn7ZE9zsjGp1xTSaDuKSRKPVsXoB5viuPNdfpGKFUy33w5XV5nFqpqoN/0h/0h/*h)");
