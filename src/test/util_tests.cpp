...
BOOST_AUTO_TEST_CASE(test_LocaleIndependentAtoi)
{
    ...
    // Ensure legacy compatibility with previous versions of QTY Core's atoi64
    for (const auto& pair : atoi64_test_pairs) {
...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("qty"), "Btq");
...
BOOST_AUTO_TEST_CASE(message_sign)
{
    ...
    // Signature over MESSAGE_MAGIC ("QTY Signed Message:\n") rather than
