...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef QTY_CHAINPARAMSSEEDS_H\n')
    g.write('#define QTY_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the qty network\n')
    ...
    g.write('#endif // QTY_CHAINPARAMSSEEDS_H\n')
