...
#ifndef QTY_SERIALIZE_H
#define QTY_SERIALIZE_H
 ...
 */
static constexpr uint64_t MAX_SIZE = 0x04000000; // 64 MB

/** Maximum amount of memory (in bytes) to allocate at once when deserializing vectors. */
static const unsigned int MAX_VECTOR_ALLOCATE = 34000000;
