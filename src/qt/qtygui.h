...
#ifndef QTY_QT_QTYGUI_H
#define QTY_QT_QTYGUI_H
...
/**
  QTY GUI main class. This class represents the main window of the QTY UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class QTYGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit QTYGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~QTYGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a qty wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, QTYUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed QTY Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(QTYUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // QTY_QT_QTYGUI_H
