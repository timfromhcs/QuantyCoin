...
{
    // Test regression https://github.com/qty/qty/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/qty-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/qty-core/gui/pull/568.
    // With fListen=false in ~/.config/QTY/QTY-Qt.conf and all else left as default,
    // qty-qt should set both -listen and -listenonion to false and start successfully.
