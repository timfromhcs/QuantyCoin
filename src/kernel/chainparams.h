...
#ifndef QTY_KERNEL_CHAINPARAMS_H
#define QTY_KERNEL_CHAINPARAMS_H
...
public:
    ...
    bool IsTestChain() const { return m_chain_type != ChainType::QTYMAIN; }
...
#endif // QTY_KERNEL_CHAINPARAMS_H
