...
BOOST_AUTO_TEST_CASE(fixed_tests)
{
    ...
    // clear QTY's, which policy.h sets to 65536. They parse under P2WSH here.
    //
    ...
    // are about 5 KB, over Bitcoin's 3600-byte ceiling and under QTY's 65536.
    ...
    // Cover the ceiling the three cases above used to cover, at the value QTY
    ...
    // its subs to all be 'u' (taken from https://github.com/rust-qty/rust-miniscript/discussions/341).
