QTY Core version 0.13.2 is now available from:

  <https://qty.org/bin/qty-core-0.13.2/>
...
- #8908 `4a974b2` Update qty-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow qty-tx to create v2 transactions (btcdrak)
