...
static void ComplexMemPool(benchmark::Bench& bench)
{
    ...
    const auto testing_setup = MakeNoLogFileContext<const TestingSetup>(ChainType::QTYMAIN);
...
{
    FastRandomContext det_rand{true};
    auto testing_setup = MakeNoLogFileContext<TestChain100Setup>(ChainType::QTYREGTEST, {"-checkmempool=1"});
    CTxMemPool& pool = *testing_setup.get()->m_node.mempool;
    LOCK2(cs_main, pool.cs);
