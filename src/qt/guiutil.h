...
#ifndef QTY_QT_GUIUTIL_H
#define QTY_QT_GUIUTIL_H
...
/** Utility functions used by the QTY Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "qty:" URI into recipient object, return true on successful parsing
