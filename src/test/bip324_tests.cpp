...
BOOST_AUTO_TEST_CASE(packet_test_vectors) {
    ...
    // The inputs below come from the BIP324 CSV (see the conversion snippet further
    // down), but the expected outputs are NOT upstream's. BIP324 mixes the network
    // magic and a fixed string into the HKDF salt, and QTY changes both:
    // "qty_v2_shared_secret" + f1b2a3d4, against upstream's
    // "bitcoin_v2_shared_secret" + f9beb4d9 (see BIP324Cipher::Initialize). Every
    // session id, garbage terminator and ciphertext therefore differs, and the
    // upstream vectors cannot pass here.
    //
    // These were regenerated with upstream Bitcoin Core's Python reference
    // (test/functional/test_framework/crypto/{chacha20,poly1305,bip324_cipher,hkdf,
    // ellswift}.py) rather than from this implementation, so they still check the C++
    // against something independent. The generator was first run with upstream's salt
    // and required to reproduce the original upstream vectors exactly before being
    // trusted to emit these. Regenerate the same way if the salt or magic changes
    // again — do not paste in whatever the C++ currently outputs.
    //
    ...
    TestBIP324PacketVector(
        ...
        "",
        false,
        "46d3ba357b89cda657ac1a50d6c29d28",
        "79e822a65612905fe5d78c0e470610c9",
        "25812c86243159457cafe9519a78d26111c7d0b216b23346646864090e34c99a",
        "f4db708757f598f61738aa73fa9acedb6c748a397e",
        "");
    TestBIP324PacketVector(
        999,
        ...
        "",
        false,
        "6d365d703ba3f522e303852fd9788405",
        "1107e937e1e65d4b67052cacc0d222a9",
        "8b420f7b21266c0319e24424ff2eb67e1c5184d64adf5ca94d6421a7932dcd9e",
        "5a57a4085dbb907096dc561cab88a729132f0072cee27f9c950d168427938fd402761193aa",
        "");
    TestBIP324PacketVector(
        0,
        ...
        false,
        "857d6ceaaaa03cc3d1e2d32cbdc41fa1",
        "b2044e6b73c4dab6e77cc9e20b7153ea",
        "3056dbc95854090fb421031015aca3c49a814e9f12fb3f7be02b954e9abed207",
        "53a058c3fb51c49d3686f4560cf95897fca9d8b85f9676341857b8242d1c10d2c6ec3aaff629d990fe7465e9c45d1627bea06ffe500843bdacbc41a77f377d6c2c7cee91813d6dc32e1abc1f4cb554581b50e5",
        "");
    TestBIP324PacketVector(
        223,
        ...
        "",
        true,
        "6d8be8b037a94afcb60095d9b85bc834",
        "00eaf9f3319951fc222af723c73faf73",
        "30ced380529399cb2c5f26c1bdc0343c8b39f29c78aea6cd5e5617204db368a5",
        "",
        "");
    TestBIP324PacketVector(
        448,
        ...
        "",
        false,
        "e8a540daa941b883c18b406e39d79a03",
        "43a673afd3556b93d1a1180383165ab8",
        "17c4eae3350b9f2a0a813eac949c4748cc9b8459e2e5ee4a3dfe6579bf54a1f2",
        "",
        "");
    TestBIP324PacketVector(
        673,
        ...
        "",
        false,
        "452134608bd4d60cdef5adfcadb56652",
        "4d054ff5007ac4ed06f81a9f788b49c6",
        "fbb0b2713ac30dba0b35993efd5f4be667e2f2d8e32e742c25f20dd172084a67",
        "",
        "");
    TestBIP324PacketVector(
        1024,
        ...
        "",
        true,
        "b4f48204b7f24fea8392279ddc331d84",
        "3b04fda3664fc8965da3dc42f1512e6d",
        "a1c2743ef15fcfe61b715a60241a0e124b37abc42fcbfb53458a06f529849cf7",
        "",
        "");
}
