Download URL: https://sourceforge.net/projects/qty/files/QTY/qty-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 QTY fee schedule (users still pay 0.01 QTY per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #qty00 - #qty99
