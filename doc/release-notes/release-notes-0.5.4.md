QTY version 0.5.4 is now available for download at:
http://sourceforge.net/projects/qty/files/QTY/qty-0.5.4/
...
http://gitorious.org/qty/qtyd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix QTY-Qt notifications under Growl 1.3.
Increase required age of QTY-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxQTY properly when installing QTY-Qt over it. (Windows)
