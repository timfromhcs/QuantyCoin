...
BOOST_AUTO_TEST_CASE(rpc_all_output_types_includes_qty_types)
{
...
BOOST_AUTO_TEST_CASE(rpc_rawsign)
{
    ...
    r = CallRPC(std::string("createrawtransaction ")+prevout+" "+
      "{\"wbmaeG6LfdyhC1UKPWr1YmBC29yAuojAvU\":11}");
    std::string notsigned = r.get_str();
    std::string privkey1 = "\"bpv19sNQTy7meT4wh7Z393XDmoCgUh1HXcToZYJDcuj1daUHUoFS\"";
    std::string privkey2 = "\"bok6qLuA3uTfL44HL5piNVqao1EHk65JhDpGcdKXt1fSrgggxkju\"";
...
BOOST_AUTO_TEST_CASE(help_example)
{
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", args), "> qty-cli -named test foo=bar b=true n=1\n");
    ...
    // test shell escape
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b'ar"}}), "> qty-cli -named test foo='b'''ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b\"ar"}}), "> qty-cli -named test foo='b\"ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b ar"}}), "> qty-cli -named test foo='b ar'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", obj_value}}), "> qty-cli -named test name='{\"foo\":\"bar\",\"b\":false,\"n\":1}'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", arr_value}}), "> qty-cli -named test name='[\"bar\",false,1]'\n");
