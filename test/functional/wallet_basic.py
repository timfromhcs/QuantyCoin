...
# because QTY's subsidy is a tenth of Bitcoin's.
SUBSIDY = block_subsidy(1)


class WalletTest(QTYTestFramework):
    ...
    def run_test(self):
        ...
        # Send 2.1 QTY from 0 to 2 using sendtoaddress call.
        ...
        # Send 1 QTY with subtract fee from amount
        ...
        # Sendmany 1 QTY with subtract fee from amount
        ...
        # Sendmany 0.5 QTY to two addresses with subtracting fee from both addresses
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid QTY address
            assert_raises_rpc_error(-5, "Invalid QTY address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid QTY address
            assert_raises_rpc_error(-5, "Invalid QTY address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid QTY address or script", self.nodes[0].importaddress, "invalid")
            ...
            assert_raises_rpc_error(-5, "Bech32m addresses cannot be imported into legacy wallets", self.nodes[0].importaddress, "qcqty1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqsjn9ns")
