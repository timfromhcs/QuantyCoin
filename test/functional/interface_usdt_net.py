...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/qty/qty/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(QTYTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our qtyd node")
