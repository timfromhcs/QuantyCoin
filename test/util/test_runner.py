...
# Copyright 2016-2017 The QTY Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for qty utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "qty-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./qty-util":
        execprog = os.getenv("QTYUTIL", default=execprog)
    elif testObj["exec"] == "./qty-tx":
        execprog = os.getenv("QTYTX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, qty-tx
