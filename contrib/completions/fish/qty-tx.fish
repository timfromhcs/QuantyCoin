...
# Extract options
function __fish_qty_tx_get_options
...
# Extract commands
function __fish_qty_tx_get_commands
...
complete \
    --command qty-tx \
    --condition "not __fish_qty_seen_cmd (__fish_qty_tx_get_commands --commandsonly)" \
    --arguments "(__fish_qty_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command qty-tx \
    --arguments "(__fish_qty_tx_get_commands)" \
    --no-files
