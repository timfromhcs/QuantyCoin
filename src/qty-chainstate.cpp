...
//
// The qty-chainstate executable serves to surface the dependencies required
// by a program wishing to use QTY Core's consensus engine as it is right
// now.
//
// DEVELOPER NOTE: Since this is a "demo-only", experimental, etc. executable,
//                 it may diverge from QTY Core's coding style.
//
// It is part of the libqtykernel project.
