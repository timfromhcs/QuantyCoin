...
{
    const auto params {CreateChainParams(ArgsManager{}, ChainType::QTYMAIN)};
    ...
    // this is a check to make sure that https://github.com/qty/qty/issues/21379 does not recur
