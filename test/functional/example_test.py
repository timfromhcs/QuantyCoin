...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the QTYTestFramework
    pass


class ExampleTest(QTYTestFramework):
    # Each functional test is a subclass of the QTYTestFramework class.
    ...
    def custom_method(self):
        ...
        QTYTestFramework class so other tests can use it."""
