...
class ImportDescriptorsTest(QTYTestFramework):
    ...
    def run_test(self):
        ...
        addresses += ["qcqty1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju77h50u7", "qcqty1qfqeppuvj0ww98r6qghmdkj70tv8qpcheekrtu2"] # wpkh subscripts corresponding to the above addresses
        ...
        addresses = [
            'qcqty1qtmp74ayg7p24uslctssvjm06q5phz4yrgnnq8p', # m/0'/0'/0
            'qcqty1q8vprchan07gzagd5e6v9wd7azyucksq2gh4jz2', # m/0'/0'/1
            'qcqty1qtuqdtha7zmqgcrr26n2rqxztv5y8rafj0255t3', # m/0'/0'/2
            'qcqty1qau64272ymawq26t90md6an0ps99qkrse6gsjpz', # m/0'/0'/3
            'qcqty1qsg97266hrh6cpmutqen8s4s962aryy77uwypuz', # m/0'/0'/4
        ]
        ...
        assert_equal(addr, 'qcqty1qdt0qy5p7dzhxzmegnn4ulzhard33s2809arjqgjndx87rv5vd0fqzdef2d') # Derived at m/84'/0'/0'/0
        change_addr = wmulti_priv.getrawchangeaddress('bech32') # uses change 0
        assert_equal(change_addr, 'qcqty1qt9uhe3a9hnq7vajl7a094z4s3crm9ttf8zw3f5v9gr2nyd7e3lnsvqwdfn') # Derived at m/84'/1'/0'/0
        ...
        assert_equal(addr, 'qcqty1qp8s25ckjl7gr6x2q3dx3tn2pytwp05upkjztk6ey857tt50r5aeqm0qjd0') # Derived at m/84'/0'/0'/1
        change_addr = wmulti_pub.getrawchangeaddress('bech32') # uses change 2
        assert_equal(change_addr, 'qcqty1qp6j3jw8yetefte7kw6v5pc89rkgakzy98p6gf7ayslaveaxqyjusmm0epj') # Derived at m/84'/1'/0'/2
