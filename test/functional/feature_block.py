...
class FullBlockTest(QTYTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure qtyd isn't accepting b26
        ...
        # Extend the b28 chain to make sure qtyd isn't accepting b28
        ...
        # must be accepted once mocktime advances inside QTY's future-time window.
        ...
        # qtyd doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the qty code has custom code which does so);
