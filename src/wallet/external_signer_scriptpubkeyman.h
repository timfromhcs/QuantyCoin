// Copyright (c) 2019-2021 The QTY Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef QTY_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define QTY_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // QTY_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
