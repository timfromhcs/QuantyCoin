QTY Core version 0.9.4 is now available from:

  https://qty.org/bin/0.9.4/
...
this update is incompatible with the QTY system and could lead to consensus
forks.

QTY Core released binaries from https://qty.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~qty/+archive/ubuntu/qty
- A third-party or self-compiled QTY Core

upgrade to QTY Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
