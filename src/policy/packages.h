...
#ifndef QTY_POLICY_PACKAGES_H
#define QTY_POLICY_PACKAGES_H
...
static constexpr uint32_t MAX_PACKAGE_WEIGHT = 40'000'000; // 40 MB package weight (must be >= ancestor/descendant limits * WITNESS_SCALE_FACTOR * 1000)
