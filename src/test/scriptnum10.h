...
#ifndef QTY_TEST_SCRIPTNUM10_H
#define QTY_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from QTY Core 0.10.0, for cross-comparison.
 */
public:
