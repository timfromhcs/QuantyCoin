...
#ifndef QTY_NODE_CONNECTION_TYPES_H
#define QTY_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/qty-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on QTY’s Peer-to-Peer Network")
...
#endif // QTY_NODE_CONNECTION_TYPES_H
