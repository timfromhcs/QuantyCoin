...
void WalletInit::AddWalletOptions(ArgsManager& argsman) const
{
    ...
    argsman.AddArg("-changetype",
                   "What type of change to use (\"legacy\", \"p2sh-segwit\", \"bech32\", \"bech32m\", or \"p2mr\"). Default is \"p2mr\" when "
                   "any recipient is a Dilithium destination (so a quantum-safe send does not return its change to a "
                   "signature scheme it was chosen to avoid), \"legacy\" when -addresstype=legacy, else it is an "
