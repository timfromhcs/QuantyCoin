QTY-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/qty/files/QTY/qty-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the QTY
...
New/changed settings (command-line or qty.conf file)
--------------------------------------------------------
