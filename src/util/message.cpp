 ...
 */
const std::string MESSAGE_MAGIC = "QTY Signed Message:\n";
 ...
 */
const std::string DILITHIUM_MESSAGE_MAGIC = "QTY Dilithium Signed Message:\n";
...
{
    static const std::string ctx{"QTY-DILITHIUM-MSG-V1"};
