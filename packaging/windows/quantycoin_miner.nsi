; QuantyCoin QTY2 Miner NSIS Installer Script
...
OutFile "..\..\dist\windows\QuantyCoin-Miner-Setup-2.0.0.exe"
InstallDir "$PROGRAMFILES64\QuantyCoin Miner"

Section "MainSection" SEC01
  SetOutPath "$INSTDIR"
  SetOverwrite ifnewer
  File /r "..\..\dist\bin\miner\*.*"
  CreateDirectory "$SMPROGRAMS\QuantyCoin"
  CreateShortCut "$SMPROGRAMS\QuantyCoin\QuantyCoin Miner.lnk" "$INSTDIR\quanty-miner-gui.exe"
  CreateShortCut "$DESKTOP\QuantyCoin Miner.lnk" "$INSTDIR\quanty-miner-gui.exe"
SectionEnd
